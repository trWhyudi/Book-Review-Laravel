                ...
                <div class="card-body pb-0">
                        <div class="d-flex justify-content-between">
                            ...
                            <form action="" method="get">
                                <div class="d-flex">
                                    <input type="text" class="form-control" name="keyword" placeholder="Search books" value="{{ Request::get('keyword') }}">
                                ...
                                <tbody>
                                    @if ($books->isNotEmpty())
                                        ...
                                        <tr>
                                            <td>{{ $book->title }}</td>
                                            <td>{{ $book->author }}</td>
                                            <td>{{ number_format($avgRating,1) }} ({{ ($book->reviews_count > 1) ? $book->reviews_count.' Reviews' : $book->reviews_count.' Reviews' }} )</td>
                                            <td>
                                                @if ($book->status == 1)
