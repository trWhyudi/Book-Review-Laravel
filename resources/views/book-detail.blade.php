            ...
            <div class="row mt-4">
                ...
                <div class="col-md-8">
                    ...
                    <div class="star-rating d-inline-flex ml-2" title="">
                        ...
                        <span class="theme-font text-muted">({{ ($book->reviews_count > 1) ? $book->reviews_count.' Reviews' : $book->reviews_count.' Reviews' }} )</span>
                    </div>
                                ...
                                <div class="card border-0 shadow-lg">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="star-rating d-inline-flex ml-2" title="">
                                            ...
                                            <span class="theme-font text-muted">({{ ($relatedBook->reviews_count > 1) ? $relatedBook->reviews_count.' Reviews' : $relatedBook->reviews_count.' Reviews' }} )</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
